...
app.get("/", (req, res) => {
  ...
  res.render("index.ejs",{years: year});
});
...
app.post("/submit", (req, res) => {
  ...
  let index = Math.floor((Math.random()*adj.length));
  let index2 = Math.floor((Math.random()*noun.length));
  res.render("index.ejs",{bandName: adj[index],nouns: noun[index2]});
});
